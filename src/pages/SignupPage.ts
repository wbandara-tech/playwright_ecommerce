...
export class SignupPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    this.accountInfoHeading = page.locator('h2:has-text("Enter Account Information"), b:has-text("Enter Account Information")');
    ...
    this.accountCreatedHeading = page.locator('h2[data-qa="account-created"], b:has-text("Account Created")');
    this.continueBtn = page.locator('a[data-qa="continue-button"]');
    this.accountDeletedHeading = page.locator('h2[data-qa="account-deleted"], b:has-text("Account Deleted")');
    this.deleteContinueBtn = page.locator('a[data-qa="continue-button"]');
  }
  ...
  async fillSignupForm(data: SignupFormData) {
    ...
    if (data.title === 'Mr') { await this.titleMr.check(); } else { await this.titleMrs.check(); }
  ...
  async clickCreateAccount() { await this.createAccountBtn.click(); }
